<template>
  <div>
    ...
    <b-container fluid class="my-table-container">
      <b-table class="my-table" hover :items="articles" :fields="fields" :current-page="currentPage" :per-page="perPage" :filter="filter" :filter-included-fields="filterOn" sort-icon-left label-sort-asc="" label-sort-desc="" label-sort-clear="" @filtered="onFiltered">
