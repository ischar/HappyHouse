<template>
  <div class="container justify-content-center text-center">
    ...
    <div class="regist justify-content-center">
      <h1 class="underline" style=" margin-top: 50px; font-size: 30px;">게시글 작성</h1>
      <div class="regist_form">
        <label for="subject" style="margin-right: 10px;">제목</label>
        <input class="w-75" type="text" id="subject" v-model="subject" ref="subject" /><br />
        <label for="content" style="margin-top: 15px;">내용</label>
        <br />
        <div class="form-group w-100">
          <textarea class="w-75" id="content" v-model="content" ref="content" cols="35" rows="5"></textarea><br />
